 ...
 */
public class WorkaroundClassWriter extends ClassWriter {
    public WorkaroundClassWriter(int flags) {
        super(flags);
    }

    public WorkaroundClassWriter(ClassReader classReader, int flags) {
